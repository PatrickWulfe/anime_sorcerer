...
void main() {
  ...
  group('FirebaseAuthenticationRepository', () {
    ...
    test('creates FirebaseAuth instance internally when not injected', () {
      expect(() => FirebaseAuthRepository(), isNot(throwsException));
    });
    ...
    group('signUp', () {
      ...
      test('succeeds when createUserWithEmailAndPassword succeeds', () async {
        expect(
          firebaseAuthRepository.signUp(email: email, password: password),
          completes,
        );
      });
    ...
    group('loginWithGoogle', () {
      ...
      test('succeeds when signIn succeeds', () {
        expect(firebaseAuthRepository.logInWithGoogle(), completes);
      });
    ...
    group('currentUser', () {
      ...
      test('returns User when cached user is not null', () async {
        ...
        expect(firebaseAuthRepository.currentUser, equals(user));
      });
    });
  });
}
